...
public class MessageRendercontroller {
	...
	public ResponseEntity<String> showmessage(){
		...
		if(hour<12)
			...
			msg="Good Night";
		//create and response entity object having response content and status code response entity contains the 1)response boy 2)http status
